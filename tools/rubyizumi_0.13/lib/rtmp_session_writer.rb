...
module RTMP
  class SessionWriter
    ...
    def send_duration
       @sock.write(serialize_packet(make_send_duration(3)))
    end
    def send_play_start(duration)
      @sock.write(serialize_packet(make_play_start_packet(5, duration)))
    end
  ...
  private
    #TIH
    def make_send_duration(request_id)
      method_name = "_result"
      connection_status = 	{
      				"duration"=>12,
      			}
    ...
    def make_play_start_packet(frame=5, duration=nil)
